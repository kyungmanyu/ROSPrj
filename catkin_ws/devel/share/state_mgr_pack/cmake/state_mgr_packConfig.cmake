...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/state_mgr_pack " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'kyungman <kyungman@lge.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'state_mgr_pack' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kyungman/catkin_ws/src/state_mgr_pack/${idir}'.  ${_report}")
    endif()
